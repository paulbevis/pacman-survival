...
function onMouseDown(event) {
  ...
  pacmanVector = finalVector / 188;
  console.log(pacmanVector, (view.center - event.downPoint), finalVector)
}

function isPacmanCaught() {
  return (pacman.intersects(topGhost) ||
  pacman.intersects(rightGhost) ||
  pacman.intersects(leftGhost));
}
